      ...
      <tr>
        <td height="750" background="images/ch27.jpg"><div id="Layer19">
          ...
          <div id="Layer22">
            ...
            <script language="JavaScript" type="text/javascript" src="images/faculty.js"></script>
          </div>
          <p>
            <script language="JavaScript" type="text/javascript" src="images/xaramenu.js"></script>
          </p>
          <div id="Layer24"><iframe name="my" width="100%" height="695" src="fprofile.jsp" scrolling="auto" style="background:url(images/ch27.jpg);"></iframe></div>
          <p>&nbsp;</p>
          <p><br>
            <br>
          </p></td>
