<%-- 
    ...
    Created on : 2 May, 2011, 7:52:25 PM
    Author     : saurabh
--%>
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
   "http://www.w3.org/TR/html4/loose.dtd">
    <%@page import="java.lang.*,java.util.Timer" %>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title>JSP Page</title>
...
<body>
    ...
    <div align="center">
      ...
      <tr background="images/back.jpg">
          <td height="48" align="center" bordercolor="#003300"><div align="right"><s:property value="#session.user"></s:property>&nbsp;&nbsp;&nbsp;&nbsp;<s:if test="#session.user!=null"><s:url id="logout" action="logout"/><s:a href="%{logout}">Logout</s:a></s:if></div ></td>
      </tr>
      <tr>
