...
<body>
<div id="Layer23">
      <div align="center"><script language="JavaScript" type="text/javascript" src="images/dept.js"></script>
    ...
    <div align="center">
      ...
      <tr background="images/back.jpg">
          <td height="48" align="center" bordercolor="#003300"><s:property value="#application.tb.AFristname"></s:property><div align="right"><s:property value="#session.user"></s:property><s:property value="#session.tb.AFirstname"></s:property>&nbsp;&nbsp;&nbsp;&nbsp;<s:if test="#session.user!=null"><s:url id="logout" action="logout"/><s:a href="%{logout}">Logout</s:a></s:if></div ></td>
      </tr>
      <tr>
        <td height="750" background="images/ch27.jpg"><div id="Layer19">
          ...
          <div id="Layer24"><iframe name="my" width="100%" height="695" src="depro.jsp" scrolling="auto" style="background:url(images/ch27.jpg)"></iframe></div>
          <p>&nbsp;</p>
          <p><br>
            <br>
          </p></td>
