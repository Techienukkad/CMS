...
<table width="75%" cellpadding="5" class="a" style="vertical-align:middle;border:0px;">
  ...
  <tr>
    <td class="h">&nbsp;</td>
    <td colspan="2"><td colspan="2"><s:url id="setq" action="setq">
            <s:param name="Id"><s:property value="#session.user"/></s:param>

        </s:url>
        <s:a href="%{setq}">Set Security question</s:a></td></td>
  </tr>
</table>
