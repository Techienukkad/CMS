...
%>
        <table width="100%" align="center" class="c">
            ...
            <td width="15%"><div align="center">Sender</div></td>
            <td width="15%"><div align="center">Time</div></td>
            <td width="15%"><div align="center">Delete</div></td>
            </tr>

          <s:set name="rec" value="#application.message"></s:set>
          <s:iterator value="rec">
            ...
            <td width="15%"><div align="center">
                    <s:url id="show" action="showMessage">
                        ...
                        <s:param name="sender"><s:property value="#application.send.sender"/></s:param>
                        <s:param name="receiver"><s:property value="#session.user"/></s:param>
                    </s:url>
                    <s:a href="javascript:openWindow('%{show}');"><s:property value="MId"/> </s:a>
                </div></td>
                <td width="15%"><div align="center"><s:property value="#application.send.sender"></s:property></div></td>
            <td width="15%"><div align="center"><s:property value="#application.Mydate"></s:property></div></td>
