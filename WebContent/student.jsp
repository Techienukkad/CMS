...
//-->
    ...
    <div align="center">
      ...
      <tr background="images/back.jpg">
          <td height="48" align="right" bordercolor="#003300"><s:property value="#session.user"></s:property>&nbsp;&nbsp;&nbsp;&nbsp;<s:if test="#session.user!=null"><s:url id="logout" action="logout"/><s:a href="%{logout}">Logout</s:a></s:if></td>
      </tr>
      <tr>
        <td height="750" background="images/ch27.jpg"><div id="Layer19">
          ...
          <div id="Layer22">
            <script language="JavaScript" type="text/javascript" src="images/side2.html"></script>
            <script language="JavaScript" type="text/javascript" src="images/sidem2.js"></script>
          </div>
          <p>
            <script language="JavaScript" type="text/javascript" src="images/xaramenu.js"></script>
          </p>
          <div id="Layer24"><iframe name="my" width="100%" height="695" src="profile.jsp" scrolling="auto" style="background:url(images/Fractal_Lumpy.gif)"></iframe></div>
          <p>&nbsp;</p>
          <p><br>
            <br>
          </p></td>
